...
SECRET_KEY = 'django-insecure-5zo^x8^titv)=bgy$ex+h%1)z7f^&#y-(ix4uw*6q_x#6z#kel'
...
REDIS_HOST = '0.0.0.0'
REDIS_PORT = '6379'
CELERY_BROKER_URL = 'redis://' + "demo_app_redis" + ':' + REDIS_PORT + '/0'
CELERY_RESULT_BACKEND = 'redis://' + "demo_app_redis" + ':' + REDIS_PORT + '/0'
